...
from src.sampling.sampling_methods.fibonacci_sampling import FibonacciSampling

class TestFibonacciSampling(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.samples = FibonacciSampling.generate_samples(self.number_of_points, self.dimensionality)
