...
from src.sampling.sampling_methods.uniform_sampling import UniformSampling
...
class TestUniformSampling(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.samples = UniformSampling.generate_samples(self.number_of_points, self.dimensionality)
