...
from src.sampling.sampling_methods.gaussian_sampling import GaussianSampling

class TestGaussianSampling(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.samples = GaussianSampling.generate_samples(self.number_of_points, self.dimensionality)
