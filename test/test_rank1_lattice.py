...
from src.sampling.sampling_methods.rank1_lattice import Rank1Lattice
...
class TestRank1Lattice(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.samples = Rank1Lattice.generate_samples(self.number_of_points, self.dimensionality)
